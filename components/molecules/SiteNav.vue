<template>
    <nav class="fixed bottom-0 left-0 z-20 flex flex-col p-4 font-serif text-lg list-none site-nav lg:text-xl xl:text-2xl 2xl:text-2xl 2xl:p-16 3xl:text-3xl ">
