    ...
    <div>
        ...
        >
            ...
            <div
                ...
                class="pt-24 bg-white dark:bg-slate-900 lg:w-1/2 lg:ml-auto"
            >
                <div
                    class="-translate-y-16 relative grid w-10/12 monitor p-1.5 pb-2 lg:pb-4 ml-auto mr-1/12 rounded-tl-lg  md:mr-4  lg:p-2  rounded-tr-xl from-gray-200 to-gray-300 bg-gradient-to-br dark:from-slate-700 dark:to-slate-900 lg:mt-4 lg:w-10/12 lg:mx-auto"
                >
                    <div
                        class="inset-0 flex col-start-1 row-start-1 transition-opacity duration-500 col-span-full bg-gradient-to-l dark:from-shiraz-700 from-gray-100 to-gray-200 dark:to-shiraz-600"
                    >
