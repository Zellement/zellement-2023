<template>
    <div>
        <nuxt-link
            class="fixed top-0 z-50 px-2.5 py-1.5 mt-4 transition-colors duration-300 -translate-x-full bg-white lg:ml-4 left-1/3 lg:translate-x-0"
            to="/"
            title="Go back"
        >
            <Icon
        ...
        <div
            v-show="data"
            :key="workData?.id"
            class="relative z-10 w-full pb-16 ml-auto text-black lg:pb-12 dark:text-slate-300 slug-content"
        >
            <div class="w-2/3 p-4 ml-auto bg-white xl:px-16">
            ...
            <div class="w-2/3 p-4 py-16 ml-auto overflow-hidden bg-white 3xl:flex 3xl:flex-row 3xl:gap-16 3xl:items-center 3xl:justify-between ">
                <ul
            ...
            <div
                ...
                class="pt-24 bg-white "
            >
                <div
                    class="-translate-y-16 relative grid w-10/12 monitor p-1.5 pb-2 lg:pb-4 ml-auto mr-1/12 rounded-tl-lg  md:mr-4 md:w-7/12 lg:p-2  rounded-tr-xl from-gray-200 to-gray-300 bg-gradient-to-br dark:from-slate-700 dark:to-slate-900 lg:w-2/5 lg:mt-4 2xl:max-w-3/4 lg:max-w-3/4"
                >
                    <div
                        class="inset-0 flex col-start-1 row-start-1 transition-opacity duration-500 col-span-full bg-gradient-to-l dark:from-shiraz-700 from-gray-100 to-gray-200 dark:to-shiraz-600"
                    >
            ...
            <div
                ...
                class="w-2/3 p-4 ml-auto text-xs bg-white dark:text-slate-300 aspect-video lg:max-w-3/4 lg:aspect-auto lg:p-8 2xl:p-12"
            >
            ...
            <div
                ...
                class="w-1/2 p-4 ml-auto text-xs text-black lg:-translate-x-8 bg-gradient-to-r from-plum-50 to-white dark:text-white dark:from-shiraz-700 dark:to-shiraz-800 xl:max-w-1/3 xl:p-8 2xl:p-12 xl:mr-1/6"
            >
